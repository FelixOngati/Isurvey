...
public class Questionnaire15 extends Activity implements OnClickListener{
	private Button next;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.questionnaire15);
		
		next = (Button) findViewById(R.id.btn_next3);
		next.setOnClickListener(this);
		
		pos = (Spinner) findViewById(R.id.sp_qst156);
		cod = (Spinner) findViewById(R.id.sp_qst158);
		...
		cod.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if(loss_reason.equals("Other")){
					AlertDialog.Builder alert = new AlertDialog.Builder(Questionnaire15.this);

					alert.setTitle("Other");
					alert.setMessage("Specify");

					// Set an EditText view to get user input 
					final EditText input = new EditText(Questionnaire15.this);
