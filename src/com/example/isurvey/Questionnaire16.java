...
public class Questionnaire16 extends Activity implements OnClickListener{
	private Button next;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.questionnaire16);
		
		next = (Button) findViewById(R.id.btn_next4);
		next.setOnClickListener(this);
		
		pos = (Spinner) findViewById(R.id.sp_qst166);
		cod = (Spinner) findViewById(R.id.sp_qst168);
		...
		cod.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if(loss_reason.equals("Other")){
					AlertDialog.Builder alert = new AlertDialog.Builder(Questionnaire16.this);

					alert.setTitle("Other");
					alert.setMessage("Specify");

					// Set an EditText view to get user input 
					final EditText input = new EditText(Questionnaire16.this);
	...
	public void onClick(View v) {
		Intent i = new Intent(this, Questionnaire17.class);
		startActivity(i);
