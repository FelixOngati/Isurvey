...
public class Questionnaire12 extends Activity implements OnClickListener{
	private Button next;
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.questionnaire12);
		
		next = (Button) findViewById(R.id.btn_next2);
		next.setOnClickListener(this);
		
		pos = (Spinner) findViewById(R.id.sp_qst126);
		cod = (Spinner) findViewById(R.id.sp_qst128);
		...
		cod.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if(loss_reason.equals("Other")){
					AlertDialog.Builder alert = new AlertDialog.Builder(Questionnaire12.this);

					alert.setTitle("Other");
					alert.setMessage("Specify");

					// Set an EditText view to get user input 
					final EditText input = new EditText(Questionnaire12.this);
	...
	public void onClick(View v) {
		Intent i = new Intent(this, Questionnaire13.class);
		startActivity(i);
