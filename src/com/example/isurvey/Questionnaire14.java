...
public class Questionnaire14 extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.questionnaire14);
		
		next = (Button) findViewById(R.id.btn_next4);
		next.setOnClickListener(this);
		
		pos = (Spinner) findViewById(R.id.sp_qst146);
		cod = (Spinner) findViewById(R.id.sp_qst148);
		...
		cod.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
				...
				if(loss_reason.equals("Other")){
					AlertDialog.Builder alert = new AlertDialog.Builder(Questionnaire14.this);

					alert.setTitle("Other");
					alert.setMessage("Specify");

					// Set an EditText view to get user input 
					final EditText input = new EditText(Questionnaire14.this);
